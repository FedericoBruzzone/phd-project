...
\colorlet{framecolor}{lime}
\colorlet{bgcolor}{lime!30}
...
\begin{frame}{\secname}
    ...
    \noindent\fcolorbox{framecolor}{bgcolor}{%%
        \parbox{\textwidth}{%
            \large \alert{RO 1}:
...
\begin{frame}
    ...
    \begin{itemize}[itemsep=20pt]
        ...
        \item Propose a \alert{feasibility study} for the methodology.
        \item We \alert{prototyped} the reduction of combinations.
        \item We \alert{prototyped} the modularization of the type system.
    \end{itemize}
...
\begin{frame}
    ...
    \begin{itemize}[itemsep=10pt]
        ...
        \item \normalsize Thomas K\"{u}hn: \scriptsize Known for his work on Software and Language Product Lines Engineering. Professor at the Martin Luther University Halle-Wittenberg, Germany.
