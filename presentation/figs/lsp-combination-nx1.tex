...
\draw[dashed, very thick, rounded corners, anchor=north]
        (1.94,-1.5) rectangle (10.06, 5)
        node[anchor=north, align=center] at (6,5.5) {$\mathbf{N} \times \mathbf{1} \text{ where } \mathbf{N} << \mathbf{L}$};
...
\draw[red, very thick, rounded corners,  blur shadow={shadow blur steps=5, shadow blur radius=5pt}]
        (2,0.4) rectangle (5.15,3.1)
        node[anchor=north west] at (2,3.05) {Java};
\draw[blue, very thick, rounded corners,  blur shadow={shadow blur steps=5, shadow blur radius=5pt}]
        (3.54,0.5) rectangle (5.04,4.75)
        node[anchor=north west] at (3.575,4.75) {C};
\draw[orange, very thick, rounded corners,  blur shadow={shadow blur steps=5, shadow blur radius=5pt}]
        (3.4,-1.25) rectangle (4.9, 3)
        node[anchor=south west] at (3.5,-1.25) {Rust};

\filldraw[color=blue, fill=blue!20, very thick](4.25,3.7) circle (0.5) node {\scriptsize typedef};
\filldraw[color=LimeGreen, fill=LimeGreen!20, very thick](4.25,2.4) circle (0.5) node {if};
\filldraw[color=LimeGreen, fill=LimeGreen!20, very thick](4.25,1.1) circle (0.5) node {for};
\filldraw[color=orange, fill=orange!20, very thick](4.25,-0.2) circle (0.5) node {trait};
\filldraw[color=red, fill=red!20, very thick](2.75,1.75) circle (0.5) node {class};

% Connections
\draw[->, >=stealth] (5.1,4)      -- (5.4,1.85);
\draw[->, >=stealth] (5.2,1.75)   -- (5.4,1.75);
