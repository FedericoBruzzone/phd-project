...
help:
	@echo "Usage:"
	@echo "  make all             - compile all figures and main file"
	@echo "  make compile_figs    - compile all figures"
...
# =============== CLEANING ===============
define clean_latex
	rm -rf $(dir $1)*.aux $(dir $1)*.bbl $(dir $1)*.blg $(dir $1)*.log $(dir $1)*.out $(dir $1)*.spl $(dir $1)*.synctex.gz $(dir $1)*.toc $(dir $1)*.bcf $(dir $1)*.run.xml $(dir $1)*.nav $(dir $1)*.snm $(dir $1)*.vrb $(dir $1)*.fdb_latexmk $(dir $1)*.fls $(dir $1).$(NAME)-cache
endef
