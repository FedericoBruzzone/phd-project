...
\noindent\fbox{%
    \parbox{\textwidth}{%
        In support of this project, a paper titled \textbf{Code Less to Code More: Streamlining LSP Development for Language Families} (F. C. Bruzzone, W. Cazzola, L. Favalli) is being written for submission to \textbf{Jurnal of Systems and Software} (JSS).
    }%
}
